...
const slotTexture = preload("res://scripts/images/skil.png");
const itemImages = [
	preload("res://scripts/images/Ac_Ring05.png"),
	preload("res://scripts/images/A_Armor05.png"),
	preload("res://scripts/images/A_Armour02.png"),
	preload("res://scripts/images/A_Shoes03.png"),
	preload("res://scripts/images/C_Elm03.png"),
	preload("res://scripts/images/E_Wood02.png"),
	preload("res://scripts/images/P_Red02.png"),
	preload("res://scripts/images/W_Sword001.png")
];
